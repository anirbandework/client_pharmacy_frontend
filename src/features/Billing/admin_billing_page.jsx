...
import { BarChart3, TrendingUp, Brain, FileText, BarChart, LayoutDashboard, Settings, Store, IndianRupee, Clock, Lock, Crown, Star } from 'lucide-react'
...
const AdminBillingPage = () => {
  ...
  const { isTabEnabled, isTabLocked, isLoaded } = useTabPermissions('billing_analytics')
  ...
  return (
    <Layout>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <LockedModuleGuard moduleKey="billing_analytics" moduleName="Billing Analytics" moduleIcon={BarChart3}>
