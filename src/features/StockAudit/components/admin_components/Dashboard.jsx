      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-4 hover:shadow-xl transition-shadow">
            ...
            <div className="text-2xl font-bold text-gray-800">{stock_overview.total_items}</div>
            <p className="text-xs text-gray-500 mt-1">Software: {stock_overview.total_quantity_software} | Physical: {stock_overview.total_quantity_physical}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-4 hover:shadow-xl transition-shadow">
            ...
            <p className="text-xs text-gray-500 mt-1">Value Impact: ₹{(discrepancy_analysis.total_value_impact || 0).toFixed(2)}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-4 hover:shadow-xl transition-shadow">
            ...
            <p className="text-xs text-gray-500 mt-1">Audited: {stock_overview.audited_items}/{stock_overview.total_items}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-4 hover:shadow-xl transition-shadow">
            ...
            <p className="text-xs text-gray-500 mt-1">Expiring 0-30d: {expiry_analysis.expiring_0_30}</p>
          </div>
        </div>
