...
const ExcelUploadVerification = () => {
  ...
  const fetchUploads = async () => {
    try {
      const response = await stockAuditAPI.getExcelUploads()
  ...
  const fetchSections = async () => {
    try {
      const response = await stockAuditAPI.getSections()
  ...
  const fetchRacks = async () => {
    try {
      const response = await stockAuditAPI.getRacks()
  ...
  const fetchUploadItems = async (uploadId) => {
    try {
      setLoading(true)
      const response = await stockAuditAPI.getUploadItems(uploadId)
  ...
  const handleStaffVerify = async (uploadId, notes) => {
    try {
      await stockAuditAPI.staffVerifyUpload(uploadId, notes)
      fetchUploads()
