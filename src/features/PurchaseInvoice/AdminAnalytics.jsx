        ...
        <div className="hidden md:block bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700 rounded-xl shadow-lg p-4 md:p-6 mb-4 animate-fade-in relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-white">Invoice Analytics</h1>
                <p className="text-white/90 text-xs md:text-sm">AI-powered insights & procurement intelligence</p>
              </div>
            </div>
...
export default AdminInvoiceAnalytics
